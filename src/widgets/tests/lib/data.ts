...
export const questionData: QuestionType[] = [
  {
    id: 1,
    question:
      'Ota-onalar va maktab o‘rtasidagi hamkorlikning asosiy maqsadi nima?',
    correctAnswer: 'O‘quvchi shaxsini har tomonlama rivojlantirish',
    options: [
      'Bolaning darslarini nazorat qilish',
      'O‘quvchi shaxsini har tomonlama rivojlantirish',
      'O‘qituvchining ishini yengillashtirish',
      'Ota-onalarning mas’uliyatini kamaytirish',
    ],
  },
  {
    id: 2,
    question: 'Ota-onalar bilan ishlashning eng samarali shakli qaysi?',
    correctAnswer: 'Turli interaktiv uchrashuvlar, treninglar, seminarlar',
    options: [
      'Faqat ota-onalar yig‘ilishi',
      'Uyga borib suhbatlashish',
      'Turli interaktiv uchrashuvlar, treninglar, seminarlar',
      'Faqat kundalik orqali xabar berish',
    ],
  },
  {
    id: 3,
    question:
      'Maktab va ota-onalar o‘rtasidagi aloqa uzilsa, bu holat nimalarga olib keladi?',
    correctAnswer: 'Tarbiyaviy muammolarning ortishiga',
    options: [
      'O‘quvchining ijobiy rivojlanishiga',
      'O‘qituvchi yukining kamayishiga',
      'Tarbiyaviy muammolarning ortishiga',
      'O‘quvchining darsga ko‘proq tayyorlanishiga',
    ],
  },
  {
    id: 4,
    question:
      'Quyidagi shakllardan qaysi biri individual hamkorlik turiga kiradi?',
    correctAnswer: 'Pedagogik maslahat',
    options: [
      'Sinf ota-onalar yig‘ilishi',
      'Pedagogik maslahat',
      'Umummaktab yig‘ilishi',
      'Bayram tadbirlari',
    ],
  },
  {
    id: 5,
    question:
      'Ota-onalar bilan ishlashda “pedagogik ma’rifat” deganda nima tushuniladi?',
    correctAnswer: 'Ota-onalarning tarbiya bo‘yicha bilim va ko‘nikmalari',
    options: [
      'Ota-onalarning bolani jazolash usullari',
      'Ota-onalarning tarbiya bo‘yicha bilim va ko‘nikmalari',
      'Faqat maktabda o‘qitiladigan darslar',
      'Bolaning baholarini bilish',
    ],
  },
  {
    id: 6,
    question: 'Maktab va oila hamkorligining asosiy tamoyili qaysi?',
    correctAnswer: 'Teng huquqlilik va o‘zaro hurmat',
    options: [
      'Teng huquqlilik va o‘zaro hurmat',
      'Faqat maktab rahbarining ustunligi',
      'Ota-onaning so‘zi hal qiluvchi bo‘lishi',
      'O‘qituvchining mustaqil qaror qabul qilishi',
    ],
  },
  {
    id: 7,
    question:
      'Quyidagilardan qaysi biri ota-onalar bilan ishlashning noformal shakliga kiradi?',
    correctAnswer: 'Uy uchrashuvlari',
    options: [
      'Uy uchrashuvlari',
      'Ota-onalar konferensiyasi',
      'Pedagogik kengash',
      'Sinf yig‘ilishi',
    ],
  },
  {
    id: 8,
    question:
      'O‘quvchi tarbiyasida maktab va oila bilan bir qatorda yana kimning ta’siri muhim?',
    correctAnswer: 'Do‘stlar va tengdoshlar muhitining',
    options: [
      'Do‘stlar va tengdoshlar muhitining',
  ...
  },
  {
    id: 9,
    question:
      'Ota-onalar va o‘qituvchilar o‘rtasidagi hamkorlikning muhim sharti bu —',
    correctAnswer: 'O‘zaro ishonch va ochiq muloqot',
    options: [
      'Faqat nazoratni kuchaytirish',
      'O‘zaro ishonch va ochiq muloqot',
      'Tanqidiy yondashuvni oshirish',
      'Bola haqida gaplashmaslik',
    ],
  },
  {
    id: 10,
    question:
      'Quyidagilardan qaysi biri maktab va oila o‘rtasidagi hamkorlikning asosiy yo‘nalishlaridan biri hisoblanadi?',
    correctAnswer: 'O‘quvchining tarbiyaviy faoliyatini muvofiqlashtirish',
    options: [
      'Dars jarayonini qisqartirish',
      'O‘quvchining tarbiyaviy faoliyatini muvofiqlashtirish',
      'O‘qituvchining hisobotini oshirish',
      'Baholash tizimini o‘zgartirish',
    ],
  },
  {
    id: 11,
    question:
      'Ota-onalar bilan ishlashda o‘qituvchi qanday fazilatga ega bo‘lishi zarur?',
    correctAnswer: 'Hurmatli, muloqotga ochiq, sabrli',
    options: [
      'Sabrsiz va qat’iy',
      'Hurmatli, muloqotga ochiq, sabrli',
      'Faqat buyruq beruvchi',
      'O‘z fikrida qat’iy turuvchi',
    ],
  },
];
